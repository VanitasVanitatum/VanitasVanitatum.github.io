...
It's also good for clicking-through repetitive forms or dialogs. If the layout of the page is consistent, the same string of commands (e.g. **fa**) will always hit the right link. So if you learn the pattern, you can hit the links efficently (or even make a AHK script to to do it for you). You can limit which letters are used in the Vimium++ settings.
